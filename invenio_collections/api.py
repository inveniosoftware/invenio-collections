...
class Collection:
    ...
    @classmethod
    def create(cls, slug, title, search_query, ctree=None, parent=None, order=None, depth=2):
    ...
    def add(self, slug, title, search_query, order=None, depth=2):
        ...
        return self.create(
            slug=slug, title=title, search_query=search_query, parent=self, order=order, depth=depth
        )
